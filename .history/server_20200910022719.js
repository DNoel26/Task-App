...
const {is_authenticated,is_authorized_admin,is_authorized_user} = require("./middleware/authorization_MW.js");

const mysql_config = require("./config/MySQLDAO.js");
const mySQL_DB = require('./config/MySQLDAO.js');
const file_upload = require("express-session")
...
app.use("/admin",is_authenticated,is_authorized_admin,admin_controller);
app.use("/user",is_authenticated,is_authorized_user,user_controller);
app.use("/task",is_authenticated,is_authorized_user,task_controller);
