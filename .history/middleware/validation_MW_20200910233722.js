...
exports.user_add_task_form = (req,res,next)=>{
    ...
    const newLocal = req.session.session_user.id;
    new_task.user_id = newLocal;
    
    req.new_task = new_task;
    ...
    {
        console.log(`New Task Added - validation_MW.js`);
        console.log(new_task);
        console.log(req.new_task);
