    ...
    get_a_user(user_id)
    {
        return new Promise((resolve,reject)=>{
            ...
            .then(([rows,fields])=>{
                    ...
                    specific_user.first_name = row[0].first_name;
                    specific_user.last_name = row[0].last_name;
                    specific_user.username = row[0].username;
                    specific_user.email = row[0].email;
                    specific_user.id = row[0].user_id;
                    specific_user.role = row[0].role;
                    specific_user.status = row[0].is_active;
