        ...
        return new Promise((resolve,reject)=>{
            ...
            .then(([rows,fields])=>{
                ...
                rows.forEach(row => {
                    ...
                    displayed_task.title = row[0].title;
                    displayed_task.description = row[0].description;
                    displayed_task.user_id = row[0].user_id;
                    displayed_task.date_created = row[0].date_created;
                    displayed_task.last_modified = row[0].last_modified;
